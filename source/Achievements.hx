...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Conflict Resolved",			"Completed the VS Shard week.",						'week1_complete',		false],
		["Shattered",					"Conquered the VS Shard week with no Misses.",		'week1_nomiss',			true],
		["Went Down Fighting",			"Beat the Boss Mode version of Calamity.",			'beat_bossmode',		true],
		["An Alternate Timeline",		"Completed Undisturbed.",							'undis_done',			true],
		["Unhinged Deities",			"Conquered Undisturbed with no Misses.",			'undis_nomiss',			true]
	];
